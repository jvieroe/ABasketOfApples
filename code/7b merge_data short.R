...
# ---------------------------------------------------------
# ----- City data
bairoch <- rio::import("data/city data/bairoch_data/bairoch_shortpanel.Rdata")
table(bairoch$year)
...
# ----- Conflict data
conf <- rio::import("data/conflict data/matched_conflict_short.Rdata")
